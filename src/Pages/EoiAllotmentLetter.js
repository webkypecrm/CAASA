                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                ...
                                <br />
                                {formData.inventory?.size}
                              </td>
                              <td>
                                <span style={{ color: "#847f7f" }}>Unit No :</span>
                                <br />
                                {formData.inventory?.unitNo}
                              </td>
              ...
              <td align="center">
                ...
                <div style={{ display: 'flex', alignItems: 'center', whiteSpace: 'nowrap' }}>
                  <Link
                    ...
                    to={`/allotment-letter-prints/${empid}`}
...
export default EoiAllotmentLetter
