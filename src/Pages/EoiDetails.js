...
const EoiDetails = () => {
    ...
    const [refaundRequest, setRefaundRequest] = useState(false);
    const [refaundRequestId, setRefaundRequestId] = useState('');
    ...
    const initialFormDataRefaund = {
        status: '',


    };

    const [refaundP, setRefaundP] = useState(initialFormDataRefaund);
    ...
    const handleOpenModaRefaund = (id) => {

        setRefaundRequest(true);
        document.body.classList.add('modal-open');
    };
    const handleCloseModalRefaund = () => {
        setRefaundRequest(false);
    ...
    const refaundRequests = async (id) => {
        const url = `${apiUrl}/eoi/refundStatus?applicantId=${empid}&status=${refaundP.status}`;
        try {
    ...
    async function getEmpps(id) {
        const url = `${apiUrl}/eoi/releaseGift?applicantId=${empid}&gift=${id}`;
    ...
    async function getEmp() {
        const url = `${apiUrl}/eoi/giftAllocation?applicantId=${empid}&gift=${formData12.gift}`;
    ...
    async function getApplied() {
        const url = `${apiUrl}/eoi/applyDetailEoiFollowUp?applicantId=${empid}`;
        let response = await fetch(url, {
            method: "GET",
            headers: {
                Authorization: `Bearer ${Token}`
    ...
    const fetchEmployeeData = async () => {
        ...
        try {
            const url = `${apiUrl}/eoi/approve?applicantId=${empid}&isApproved=true`;
    ...
    const fetchEmployeeDatas = async () => {
        ...
        try {
            const url = `${apiUrl}/eoi/approve?applicantId=${empid}&isApproved=false`;
    ...
    const fetchEmployeeDatass = async () => {
        ...
        try {
            const url = `${apiUrl}/eoi/approve?applicantId=${empid}&isApproved=Hold`;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addNotes?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const fetchDataFromApii = async () => {
        ...
        const url = ` ${apiUrl}/eoi/applicants?userId=${employee2.userId}&stage=${stage}`;
    ...
    const fetchDataFroms = async () => {
        ...
        const url = `${apiUrl}/eoi/allocatedGift?applicantId=${empid}`;
    ...
    const handleSubmit2 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addCall?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit3 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addMeeting?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit4 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addReminder?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit5 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addNotice?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit6 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/postNoc?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit7 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/postRegistry?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit9 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/cancelAllocation?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit10 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addUpcomingPayment?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmit11 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/addBBA?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const fetchLeadData = async () => {
        try {
            const url = `${apiUrl}/eoi/getInventoryFollowUp?applicantId=${empid}`;
            const response = await fetch(url, {
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
            ...
            if (responseData.status === 'success' && Array.isArray(responseData.data)) {
                const formattedData = responseData.data.map(item => ({
                    ...
                    amount9: item.amount && item.amount.length > 0 ? item.amount : null,
    ...
    const fetchDataFromApi = () => {
        ...
        fetch(`${apiUrl}/eoi/getApplicantNotice?applicantId=${empid}`, {
            headers: {
                'Authorization': `Bearer ${Token}`
            }
        })
    ...
    return (
        <>
            ...
            <div className="page" >
                                        ...
                                        <div className="card custom-card" >
                                            <div className="card-body" style={{ width: '600px' }}>
                                                <div>
                                                    ...
                                                    <span className="text-muted">Type:{employee2?.schemeType}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div className="card custom-card border mb-3">
                                                            <div className="card-header pb-2" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                                                ...
                                                                <div style={{ display: 'flex', gap: '10px' }}>
                                                                    ...
                                                                    <Link
                                                                        className={`btn btn-rounded btn-rounded-sm mb-3 ${isDisabled ? 'disabled-link' : ''}`}
                                                                        style={{
                                                                            color: 'white',
                                                                            backgroundColor: isDisabled ? 'gray' : 'darkred',
                                                                            width: '180px',
                                                                            pointerEvents: isDisabled ? 'none' : 'auto',
                                                                        }}
                                                                        to={isDisabled ? '#' : `/document-list/${empid}`}
                                                                ...
                                                                <div className="row">
                                                                        ...
                                                                        <ul className="notification mb-0">
                                                                            ...
                                                                            {leadDetailsfollowups.length > 0 ? (
                                                                                ...
                                                                                leadDetailsfollowups.map(comment => {
                                                                                                    ...
                                                                                                    <div className="media mt-0">
                                                                                                        ...
                                                                                                        <div className="media-body ms-2 d-flex">
                                                                                                            ...
                                                                                                            <div className="">
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    {comment?.eoiApplicant?.paymentPlan === 'SP' && (
                                                                                                                        <>
                                                                                                                            BSP (Rs.): {comment?.inventory?.bspSP}
                                                                                                                        </>
                                                                                                                    )}

                                                                                                                    {comment?.eoiApplicant?.paymentPlan === 'PLP' && (
                                                                                                                        <>
                                                                                                                            BSP (Rs.): {comment?.inventory?.bspPLP}
                                                                                                                        </>
                                                                                                                    )}

                                                                                                                    {comment?.eoiApplicant?.paymentPlan === 'DLP' && (
                                                                                                                        <>
                                                                                                                            BSP (Rs.): {comment?.inventory?.bspDLP}
                                                                                                                        </>
                                                                                                                    )}
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    PLC Value(Rs): {comment?.inventory?.plcValue}
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    EDC/IDC: {comment?.inventory?.edcIdc}

                                                                                                                </p>

                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    EDC/IDC Value (Rs.): {comment?.inventory?.edcIdcValue}

                                                                                                                </p>

                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    Total cost (Rs.): {comment.eoiApplicant?.totalCost}
                                                                                                                </p>

                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    Facing: {comment?.inventory?.facing}
                                                                                                                </p>
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    Payment Plan: {comment?.eoiApplicant?.paymentPlan}
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    Proof:  {comment?.paymentLedger?.[0]?.paymentReceipt?.[0]?.receiptPdf ? (
                                                                                                                        <Link to={comment.paymentLedger[0].paymentReceipt[0].receiptPdf} target="_blank" title="View">
                                                                                                                            <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                                        </Link>
                                                                                                                    ) : (
                                                                                                                        <span title="Not Found">

                                                                                                                            <Link target="_blank" title="View">
                                                                                                                                <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                                            </Link>
                                                                                                                        </span>
                                                                                                                    )}
                                                                                                    ...
                                                                                                    <div className="media mt-0">
                                                                                                        ...
                                                                                                        <div className="media-body ms-2 d-flex">
                                                                                                            ...
                                                                                                            <div className="">
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />{" "}
                                                                                                                    View Welcome Letter   <Link to={`/welCome-latter-views/${comment?.id}`} target="blanck" title="View">
                                                                                                                        <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                                    </Link>
                                                                                                                </p>
                                                                                    ...
                                                                                    } else if (comment.type === 'allotmentLetter') {
                                                                                        return (
                                                                                            <li>
                                                                                                <div className="notification-time">
                                                                                                    <p className="mb-0 ">
                                                                                                    ...
                                                                                                    <div className="media mt-0">
                                                                                                        ...
                                                                                                        <div className="media-body ms-2 d-flex">
                                                                                                            ...
                                                                                                            <div className="">
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />{" "}
                                                                                                                    View Allotment Letter   <Link to={`/eoi-allotment-letter/${comment.eoiApplicantId}`} target="blanck" title="View">
                                                                                                                        <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                                    </Link>
                                                                                                                </p>
                                                                                                    ...
                                                                                                    <div className="media mt-0">
                                                                                                        ...
                                                                                                        <div className="media-body ms-2 d-flex">
                                                                                                            ...
                                                                                                            <div className="">
                                                                                                                ...
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />{" "}
                                                                                                                    Amount: {comment.demandLetter[0]?.paymentDue || 'N/A'}
                                                                                                                </p>
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />{" "}
                                                                                                                    Due Date: {comment.demandLetter[0]?.duePaymentDate || 'N/A'}
                                                                                                                </p>
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />{" "}
                                                                                                                    View Demand Letter   <a href={comment.demandLetterPDF} target="__blanck" title="View">
                                                                                                                        <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                                    </a>
                                                                                                                </p>
                                                                                    ...
                                                                                    } else if (comment.type === 'refundRequest') {
                                                                                        return (
                                                                                                ...
                                                                                                <div className="notification-body">
                                                                                                    <div className="media mt-0">
                                                                                                        ...
                                                                                                        <div className="media-body ms-2 d-flex">
                                                                                                            ...
                                                                                                            <div className="">
                                                                                                                <p className="tx-14 text-dark mb-0 tx-semibold">
                                                                                                                    {comment.creatorId}, Refund Request
                                                                                                                </p>

                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                                    Amount: {comment.amount9}
                                                                                                                </p>
                                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                    ...
                                                                                    <div className="media mt-0">
                                                                                        ...
                                                                                        <div className="media-body ms-2 d-flex">
                                                                                            ...
                                                                                            <div className="">
                                                                                                ...
                                                                                                <p className="mb-0 tx-13 text-dark">
                                                                                                    <i className="fe fe-chevrons-right me-1" />
                                                                                                    Proof:  <Link to={employee3 && employee3?.paymentLedger && employee3?.paymentLedger && `${employee3?.paymentLedger?.uploadRecipt}`} target="blanck" title="View">
                                                                                                        <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                    </Link>
                                                                                                </p>
                                                                                                <br />
                                                                    ...
                                                                    <div className="col-sm-2">
                                                                        ...
                                                                        <Link
                                                                            className="btn  btn-rounded btn-rounded-sm mb-3 btn-fullWidth"
                                                                            style={{ color: 'white', backgroundColor: 'black' }}
                                                                            to={`/eoi-single-payment-entry/${empid}`}
                                                                        ...
                                                                        <Link
                                                                            to={`/eoi-single-payment-ladger/${empid}`}
                                                                            className="btn  btn-rounded btn-rounded-sm mb-3 btn-fullWidth"
                                                                            style={{ color: 'white', backgroundColor: 'black' }}
                                            ...
                                            {users2.map((user) => (
                                                <tr key={user.id}>
                                                    ...
                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                        <span style={{ fontWeight: 'bold' }}>Project:</span> {user.projectId}
                                                        <br />
                ...
                <div
                    className={`modal fade ${refaundRequest ? 'show d-block' : ''}`}
                    id="modaldemo-callback-form"
                    tabIndex="-1"
                    style={{ display: refaundRequest ? 'flex' : 'none', top: '20px', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}
                >
                        ...
                        <div className="modal-content" style={{ borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)' }}>
                            <div className="modal-header" style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6', borderRadius: '10px 10px 0 0' }}>
                                ...
                                <button
                                    type="button"
                                    className="btn-close"
                                    onClick={handleCloseModalRefaund}
                                    aria-label="Close"
                                    style={{ outline: 'none', cursor: 'pointer' }}
                                ></button>
                            </div>
                                ...
                                <form>
                                    <div className="row row-sm">
                                        ...
                                        <div className="col-sm-12 form-group">
                                            ...
                                            <select className="form-control select2"
                                                name="status"
                                                value={refaundP.status}
                                                onChange={handleInputChangeRefaundRequests}
                                            >
                                                <option value=''>Select </option>
