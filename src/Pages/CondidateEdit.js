    ...
    const fetchUser = async () => {
      ...
      try {
        ...
        setFormData((prevFormData) => ({
          ...
          dateOfJoining: trimmedData.dateOfJoining,
          aadharNumber: trimmedData.aadharNumber,
          ...
          mobileBill: trimmedData.mobileBill,
          extraIncentive: trimmedData.extraIncentive,
