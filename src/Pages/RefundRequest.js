...
const RefundRequest = () => {
    ...
    const handleSubmit = async (id) => {
        const url = `${apiUrl}/eoi/refundStatus?applicantId=${isModalOpen3}&status=${formData.status}`;
        try {
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/eoi/getEoiApplicants?projectId=${projectId}&from=${from}&to=${to}&isRefund=true`;
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            {filteredUsers.map((user) => (
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        Amount: {user.refundRequest[0]?.amount}
                                                                                        <br />
