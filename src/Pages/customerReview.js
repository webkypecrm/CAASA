...
function CustomerReviewList() {
  ...
  `;
    ...
    const handleApprove = async (id, status) => {
        try {
            const response = await axios.get(`${apiUrl}/ldApp/approveReview`, {
                headers: {
                    "Authorization": `Bearer ${Token}`,
                },
                params: {
            ...
            // reload or update list if needed
        } catch (error) {
    ...
    const fetchDataFromApi = () => {
        ...
        fetch(`${apiUrl}/ldApp/listReviews?search=${filterByObj.search}`, {
            headers: {
                Authorization: `Bearer ${Token}`,
            },
        })
                                                    ...
                                                    <table className="table table-striped table-bordered text-nowrap mb-0">
                                                        ...
                                                        <tbody>
                                                            {users.map((user) => (
                                                                <tr key={user.id}>
                                                                    <td>{user.id}</td>
                                                                    <td>{user?.user?.mobileNumber || 'N/A'}</td>
                                                                    ...
                                                                    <td>
                                                                        {user.video ? (
                                                                            <Link to={user.video} title="Video" target="_blank">
