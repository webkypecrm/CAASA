                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">
                                        Manage Customer Demand Letters
                                    </h2>
                                </div>
                            </div>
                            {/* End Page Header */}
                                                                        ...
                                                                        <tbody>
                                                                            {filteredUsers.map((user) => (
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        Unit no: <font color="red">{user && user.applicant && `${user.applicant.unitNo}`}</font>
                                                                                        <br />
                                                                                        Area: <font color="red">{user.size}</font>
                                                                                        <br />
                                                                                        Gift: <font color="red"> {user && user.applicant && `${user.applicant.gift}`}  {user && user.applicant && `${user.applicant.otherGift}`}</font>

                                                                                    </td>
                                                                                    <td>
                                                                                        Demand Letter View:   <Link to={`/demand-latter-view/${user.inventoryFollowUpId}`} target="__blanck" title="Welcome Letter">
...
export default CustomersDemandLatters
