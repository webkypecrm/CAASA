...
const ConvertToStaff = () => {
    ...
    const [desiOptions, setDesiOptions] = useState([]);
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            try {
                ...
                setDesiOptions(oldSelectedDesi.data);
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Add Staff</h2>
                                                ...
                                                <div className="">
                                                    <div className="row row-sm">
                                                        <div className="col-lg-6 form-group">
                                                            ...
                                                            <select className="form-control" name="select" value={formData.select} onChange={handleInputChange}>
