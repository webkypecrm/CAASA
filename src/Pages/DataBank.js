...
const DataBank = () => {
    ...
    const leadsAssign = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/lead/assignLead?leadsId=${selectedItems}&isLeadBank=true`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const handleSubmits = async (e) => {
        ...
        try {
            ...
            const url = `${apiUrl}/lead/bankLeadExcel?to=${to}&from=${from}&search=${search}&clientName=${clientName}&clientNumber=${clientNumber}&status=${status}&employeeId=${employeeId}&project=${project}&source=${source}&size=${size}&page=${pageNumber}&limit=${itemsPerPage}&leadIds=${selectedItems}&search=${search}&utmSource=${utmSource}&vendor=${vendor}`;
    ...
    const fetchDataFromApi = async () => {
        ...
        const pageNumber = currentPage + 1;
        const { to, from, clientName, clientNumber, status, employeeId, project, source, size, search, utmSource, vendor } = filterByObj;
        const url = `${apiUrl}/lead/getAllLead?to=${to}&from=${from}&clientName=${clientName}&clientNumber=${clientNumber}&status=${status}&employeeId=${employeeId}&project=${project}&source=${source}&size=${size}&page=${pageNumber}&limit=${itemsPerPage}&search=${search}&utmSource=${utmSource}&vendor=${vendor}&isLeadBank=true`;
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Lead Data Bank({leadCount})</h2>
                                </div>
