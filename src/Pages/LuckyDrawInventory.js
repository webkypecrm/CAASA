...
const LuckyDrawInventory = () => {

    const location = useLocation();
    const { firstName, lastName, projectId, isLuckyDraw, fullName } = location.state || {};
    ...
    useEffect(() => {
        ...
        if (employee.type === 'Shopkhh' && !isNaN(sizeValue)) {
    ...
    const fetchDataFromApi = async () => {
        const {
            projectId, schemeId, schemeType, unitNo, plc, size,
            allocatedTo, availability, registry, luckyDrawStatus
        } = filterByObj;

        const url = `${apiUrl}/inventory/getInventory?schemeId=${schemeId}&type=${schemeType}&unitNo=${unitNo}&plc=${plc}&size=${size}&allocatedTo=${allocatedTo}&availability=${availability}&projectId=${projectId}&registry=${registry}&isEoi=false&luckyDrawStatus=${luckyDrawStatus}`;
        setLoading(true);
        try {
            const response = await fetch(url, {
                                                            ...
                                                            {users.map((user) => (
                                                                <tr>
                                                                    ...
                                                                    <td style={{ padding: '8px', border: '1px solid #ddd', minWidth: '100px' }}>
                                                                        <input className="form-control input-sm" type="text" name="row-1-age" defaultValue={user.unitNo} />
                                                                    </td>
                                                                    ...
                                                                    <td style={{ padding: '8px', border: '1px solid #ddd', minWidth: '120px' }}>
                                                                        ...
                                                                        <div style={{ position: 'relative' }}>
                                                                            ...
                                                                            {isLuckyDraw === false && user.luckyDrawStatus !== 'Allocated' ? (
                                                                                <>
                                                                                    <button
                                                                                        type="button"
                                                                                        className="btn ripple btn-info btn-xs w-100 mb-1"
                                                                ...
                                                                <tr style={{ background: "#d6f6ff26" }}>
                                                                    ...
                                                                    <th className="tx-left">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            name="areaFPP"
                                                                            value={formData12.areaFPP}
                                                                            onChange={handleInputChange}

                                                                        />  <span style={{ fontSize: '9px' }}>{formData12.areaUnitFPP} </span>
                                                                ...
                                                                <tr style={{ background: "#d6f6ff26" }}>
                                                                    ...
                                                                    <th className="tx-left">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            style={{ width: 80, height: 25, display: "inline" }}
                                                                            name="areaDLP"
                                                                            value={formData12.areaDLP}
                                                                            onChange={handleInputChange}

                                                                        /> <span style={{ fontSize: '9px' }}>{formData12.areaUnitDLP}</span>
...
export default LuckyDrawInventory
