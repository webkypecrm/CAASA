...
const AllocatedList = () => {
  ...
  const loadcontent2 = (id) => {
    window.open(`/Inventory-details/${id}`);
  };
  ...
  const fetchDataFromApi = async () => {
    ...
    const { projectId, schemeId, schemeType, from, to, search, luckyDrawId } =
      filterByObj;

    const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&stage=${stage}&page=${pageNumber}&limit=${itemsPerPage}&search=${search}&luckyDrawId=${luckyDrawId}`;
        ...
        if (Array.isArray(data.data)) {
          const formattedData = data.data.map((item) => ({
            ...
            formattedDate: item.applicantDOB
              ...
              : "",
            formattedDate2: item.coApplicantDOB
              ? formatDateTime(item.coApplicantDOB)
              : "",
            formattedDate3: item.chequeDate
  ...
  const breakContent = (content) => {
    ...
    chunks[chunks.length - 1] = chunks[chunks.length - 1].slice(0, -1); // Remove the last extra comma
                      ...
                      <div className="card-body py-3">
                        <div className="row">
                          ...
                          <div className="col-sm-4">
                            <div
                              ref={dropdownRefs}
                              style={{ position: "relative", width: "408px" }}
                            >
                              {/* Dropdown Header */}
                              <div
                                      ...
                                      {currentPageData.map((user) => (
                                        <tr>
                                          ...
                                          <td style={{ padding: "10px" }}>
                                            ...
                                            {user.userIpAddress[0]?.ipAddress}
                                            <br />
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
                                            ...
                                            {user.userIpAddress[0]?.deviceName}
                                            <br />
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
                                            ...
                                            <a
                                              onClick={() =>
                                                loadcontent2(user.id)
                                              }
                                              className="btn ripple btn-info btn-xs w-70 mb-1"
                                              style={{
                                          ...
                                          <td style={{ padding: "10px" }}>
                                            ...
                                            {new Date(
                                              user?.luckyDraw?.announcementDateTime
                                            ).toLocaleDateString("en-GB", {
                                              day: "2-digit",
                                              month: "long",
                                              year: "numeric",
                                          ...
                                          <td style={{ padding: "10px" }}>
                                            ...
                                            {user.coAdvisorName || "N/A"}
                                            <br />
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
                                              {" "}
                                              Co Advisor Mobile No:
                                            </strong>{" "}
                                            {user.coAdvisorMobileNo || "N/A"}
                                            <br />
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
                                          ...
                                          <td style={{ padding: "10px" }}>
                                            ...
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
                                              Fixed Charges (EDC/IDC):
                                            </strong>{" "}
                                            {user.fixedCharges || "N/A"}
                                            <br />
                                            <strong
                                              style={{ color: "#007bff" }}
                                            >
          ...
          >
            ...
            >
              ...
              >
                {[
                  [
                    { label: "Lucky Draw", status: "fail" },
                    { label: "Scheme", status: "fail" },
                  ],
                  [
                    { label: "Project", status: "pass" },
                    { label: "Unit Type", status: "pass" },
                    { label: "Unit No", status: "pass" },
                    { label: "Size", status: "pass" },
                  ],
                  [
                    { label: "BSP", status: "pass" },
                    { label: "EDC/IDC", status: "pass" },
                    { label: "PLC", status: "pass" },
                  ],
                ...
                >
                  This application will be moved to case change to Re-Award unit
                  and follow process.
                </p>
