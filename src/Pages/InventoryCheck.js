...
const InventoryCheck = () => {
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/inventory/getInventory?schemeId=${schemeId}&type=${schemeType}&unitNo=${unitNo}&plc=${plc}&size=${size}&allocatedTo=${allocatedTo}&availability=${availability}&projectId=${projectId}&registry=${registry}&isEoi=false&luckyDrawStatus=${luckyDrawStatus}&isApproved=${selectedOptions}`;
        setLoading(true);
        try {
            const response = await fetch(url, {
