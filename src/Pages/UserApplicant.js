                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Applicants List ({leadCount})</h2>
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item">
                                            <Link href="">All the User Sign up from App or Admin </Link>
                                        </li>
                                    </ol>
                                </div>
                                                    ...
                                                    <table className="table table-striped table-bordered mb-0">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>ID</th>
                                                                <th style={{ whiteSpace: 'nowrap' }}>Basic Details</th>
                                                                <th style={{ whiteSpace: 'nowrap' }} >Personal Details</th>
                                                                <th style={{ whiteSpace: 'nowrap' }}>Address</th>
                                                                <th style={{ whiteSpace: 'nowrap' }}>Awarded</th>
                                                            ...
                                                            {currentPageData.map((user) => (
                                                                <tr >
                                                                    ...
                                                                    <td >
                                                                        ID: {user.id || 'N/A'}
                                                                        <br />
                                                                        <span style={{ whiteSpace: 'nowrap' }}>Date/Time: {user.last_login_date
                                                                            ? new Intl.DateTimeFormat('en-US', {
                                                                                ...
                                                                                minute: '2-digit',
                                                                                hour12: true,
                                                                            }).format(new Date(user.last_login_date))
                                                                            : 'N/A'}
                                                                        </span>
                                                                        <br />
                                                                        OTP: <strong>{user.otpHash || 'N/A'}</strong>
                                                                        <br />
                                                                        <span style={{ whiteSpace: 'nowrap' }}>Otp Expire At: {user.otpTimestamp
                                                                            ? new Intl.DateTimeFormat('en-US', {
                                                                                day: '2-digit',
                                                                                month: 'long',
                                                                                year: 'numeric',
                                                                                ...
                                                                                minute: '2-digit',
                                                                                hour12: true,
                                                                            }).format(new Date(user.otpTimestamp))
                                                                            : 'N/A'}
                                                                        </span>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                                        DOB: {user.dob ? new Date(user.dob).toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' }).replace(',', '') : 'N/A'}
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <br />
                                                                        <span style={{ whiteSpace: 'nowrap' }}> City: {user.cityName || 'N/A'}</span>
                                                                    </td>

                                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                                        Total Application: {user.applicantCount}
                                                                        <br />
                                                                        Awarded: {user.awardedCount}

                                                                        <br />
                                                                        Un-Awarded: {user.unAwardedAllocated}
                                                                    </td>
                                                                    ...
                                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                                        ...
                                                                        Allocated: {user.allocationCount}
                                                                        <br />
                                                                        Not Allocated: {user.notAllocated}
                                                                    </td>

                                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                                        {user.isMobileNoVerified === true && leadCounts === false && (
