...
const NotEoiApplications = () => {
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/eoi/getEoiApplicants?projectId=${projectId}&from=${from}&to=${to}&isApproved=true&isRefund=false&hasSubscription=false&stage=Applied`;
...
export default NotEoiApplications
