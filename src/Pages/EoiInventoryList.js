...
const EoiInventoryList = () => {
    ...
    const fetchDataFromApi = async () => {
        ...
        try {
            ...
            const url = `${apiUrl}/inventory/getInventory?isEoi=true&unitNo=${unitNo}&status=${status}&type=${type}&projectId=${eoi.projectId}&membership=${eoi && eoi.projectsubscription && `${eoi.projectsubscription.eoiCode}`}`;
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5 d-flex align-items-center">
                                        ...
                                        <input
                                            type="text"
                                            className="form-control mx-2" // Add margin on the x-axis for space
                                            placeholder="Unit no..."
                                            name="unitNo"
                        ...
                        <div className="modal-content" style={{ borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)' }}>
                            <div className="modal-header" style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6', borderRadius: '10px 10px 0 0' }}>
                                <h5 className="modal-title">
                                    ...
                                    UNIT: ({unitNo}) ::: ({firstName} {middleName} {lastName}) ({empid4}) ::: Selected {plansType} Unit
                                ...
                                <form>
                                    ...
                                    <div className="row row-sm" style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        ...
                                        <div className="col-sm-6" style={{ fontSize: '14px' }}>
                                            {employee4 && employee3.projectsubscription && (
                                                <>
                                                    {employee3.projectsubscription.eoiCode === 'SLV' && (
                                                        <>
                                                            <label>
                                                                <input
                                                                    type="checkbox"
                                                                ...
                                                                /> Silver EOI Discount: Rs. 3,00,000
                                                            </label>
                                                            <br />
                                                            <label>
                                                                <input
                                                                    ...
                                                                    name="option4"
                                                                    onChange={handleCheckboxChange}
                                                                /> Platinum Plus Discount: Rs. 2,00,000 (Additional)
                                                            </label>
                                                            <br />
                                                    ...
                                                    {employee3.projectsubscription.eoiCode === 'GLD' && (
                                                        <>
                                                            <label>
                                                                <input
                                                                    type="checkbox"
                                                    ...
                                                    {employee3.projectsubscription.eoiCode === 'PLT' && (
                                                        <>

                                                            {employee5.showPltDiscount === true && (
                                                                <label>
                                                                    <input
                                                                        type="checkbox"
                                                                        name="option3"
                                                                        onChange={handleCheckboxChange}
                                                                    /> Platinum EOI Discount: Rs. 5,00,000
                                                                </label>
                                                            )}
                                                            <br />
                                                            <label>
