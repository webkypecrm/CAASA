...
`;
    ...
    const loadcontent7 = (id, fullName, middleName, lastName, user) => {
        navigation(
            `/inventorys-check/${id}/${fullName}/${lastName}`,
            {
                state: {
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&stage=${stage}&page=${pageNumber}&limit=${itemsPerPage}&search=${search}&luckyDrawId=${luckyDrawId}&isUpdated=0&resultStatus=0&isWLD=true&isVerified=N/A`;
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">
                                        WLD Applications List ({leadCount})
                                    </h2>
                                </div>
                                {!leadCounts === true &&
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style={{ padding: '15px', textAlign: 'center' }}>
                                                                                        ...
                                                                                        {user.isWelcomeLetter === false && (
                                                                                            <>
                                                                                                <Link
                                                                                                    to={`/send-welCome-latter/${user.id}`}
                                                                                                    type="button"
                                                                                                    className="btn ripple btn-info btn-xs w-100 mb-1"
                                                                                                    style={{ marginTop: '5px', backgroundColor: '#17a2b8', borderColor: '#17a2b8' }}
                                                                                                >
...
export default LdubsApplication
