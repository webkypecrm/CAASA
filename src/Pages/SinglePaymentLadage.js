...
const SinglePaymentLadage = () => {
    ...
    const fetchDataFromApi = async () => {
        setLoading(true);
        try {
            const url = `${apiUrl}/payment/paymentLedgerList?applicantId=${empid}`;
                                                                        ...
                                                                        <tbody>
                                                                            {users.map((user) => (
                                                                                <tr key={user.id}>
                                                                                    ...
                                                                                    <td>
                                                                                        {user.collectionMode === 'Online' ? user.select ?? 'N/A' : null}
                                                                                        {user.collectionMode === 'Cash Deposit' && 'Cash'}
                                                                                        {user.collectionMode === 'Cheque' && 'Cheque'}
                                                                                        {user.collectionMode === 'Discount' && 'Discount'}
                                                                                    </td>
...
export default SinglePaymentLadage