...
const UploadResult = () => {
    ...
    const fetchDataFromApi = async ({
        ...
        setLoading(true);
        const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId || ''}&isUpdated=1&resultStatus=2&search=${search}&stage=Applied&isCaseChange=false`;
    ...
    const handleSubmit7 = (event) => {
        ...
        const url = `${apiUrl}/applicant/exportApplicantsToExcelLD?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId || ''}&isUpdated=1&resultStatus=2&search=${search}&stage=Applied&isCaseChange=false`;
                                ...
                                <div>
                                    ...
                                    >
                                        <span style={{ fontSize: "16px", marginRight: '10px' }}>
                                            ...
                                            LD Unit Free List ({luckyDraw.luckyDrawName})
                                        </span>{" "}
