                                                                        ...
                                                                        <tbody>
                                                                            {filteredUsers.map((user) => (
                                                                                <tr key={user.id}>
                                                                                    ...
                                                                                    <td>
                                                                                        Name: {user.coApplicantFirstName} {user.coApplicantMiddleName} {user.coApplicantLastName}<br />
                                                                                        Email: {user.coApplicantEmail}<br />
                                                                                        Mobile: +91 {user.coApplicantMobile}<br />
                                                                                        Alternate Number: +91 {user.coApplicantAlternateNumber}<br />
                                                                                    ...
                                                                                    <td style={{ textAlign: 'center' }}>
                                                                                        <button className="btn ripple btn-primary btn-xs w-70 equal-buttons">Done</button>
                                                                                    </td>
                                                                                    <td style={{ textAlign: "center" }}>
                                                                                        <a
