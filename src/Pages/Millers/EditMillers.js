...
const EditMillers = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            try {
                const url = `${apiUrl}/miller/miller/${empid}`;
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/miller/updateMiller/${empid}`, {
                method: 'PATCH',
                headers: {
                    'Authorization': `Bearer ${Token}`,
                },
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Millers Update</h2>
