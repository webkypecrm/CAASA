...
const LeadDashboardS = () => {
    ...
    const formattedDate = selectedDate ? selectedDate.format('MM-YYYY') : moment().format('MM-YYYY');
    ...
    const displayDate = selectedDate ? selectedDate.format('MMMM YYYY') : moment().format('MMMM YYYY');
    ...
    const pieData = {
        labels: ['other', 'Ashutosh Facebook', 'Facebook', 'Rinku facebook', 'Sayyed facebook', 'Suraj facebook', 'Suraj WA'],
        datasets: [
            {
                label: 'UTM Source',
                data: [
    ...
    const barDatas = {
        labels: [
            'New Lead', 'Not enquired', 'Not Interested', 'Not Connected', 'Hot Lead',
            'Meeting Done', 'Form Done', 'Follow up', 'Sales Projection', 'Outstation',
            'Search', 'Dead Other Issue', 'Payment Received(10%)', 'Payment Received(30%)',
            'Dead Budget Issue'
        ],
        datasets: [
            {
                            ...
                            <div style={{
                                ...
                                <Space direction="vertical" size={12}>
                                    <DatePicker
                                        ...
                                        style={{ height: "35px", width: "200px", color: 'green' }}
                                    />
                                </Space>{" "}  <span style={{ marginLeft: '16px', fontSize: '16px', color: '#333' }}>
                                    {displayDate}
                                </span>
                            </div>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        <Space direction="vertical" size={12} style={{ marginRight: 'auto' }}>
                                            <DatePicker
                                                onChange={onChange3}
                                                picker="year"
                                                value={selectedDate2}
