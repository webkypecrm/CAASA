...
const NOCList = () => {
    ...
    const fetchDataFromApi = async () => {
        setLoading(true);
        try {
            const url = `${apiUrl}/applicant/nocListing`;
            ...
            if (data.status === 'success') {
                if (Array.isArray(data.data)) {
                    const formattedData = data.data.map(item => ({
                        ...
                        id: item.applicant && item.applicant.length > 0 ? item.applicant[0].id : null,
                    }));
                                                                        ...
                                                                        <tbody>
                                                                            {filteredUsers.map((user) => (
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        Noc view:   <Link to='' target="__blanck" title="NOC View">
