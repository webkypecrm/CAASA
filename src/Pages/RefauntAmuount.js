...
const RefauntAmuount = () => {
    ...
    const handleSubmit2 = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/applicant/refundStatus?applicantId=${isModalOpen8}&status=Pending`, {
                method: "POST",
                headers: {
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            {filteredUsers.map((user) => (
                                                                                <tr>
                                                                                    ...
                                                                                    <td>Requested</td>
                                                                                    <td>
                                                                                        <span style={{ color: 'green' }}>New Request</span>
                                                ...
                                                <div className="row row-sm">
                                                    <div className="col-sm-12 form-group" style={{ marginBottom: '15px' }}>
                                                        ...
                                                        <select className="form-control" style={{ border: '1px solid #ced4da', borderRadius: '5px', padding: '8px', width: '100%', fontSize: '14px', color: '#495057' }}>
                                                            ...
                                                            <option style={{ color: '#495057' }} value="1">Khushal Chopra</option>
                                                        </select>
                                                    </div>
                                                </div>
