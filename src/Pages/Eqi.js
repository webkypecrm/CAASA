...
const Eqi = () => {
    ...
    const loadcontent = (id) => {
        navigation(`/edit-eoi-customer/${id}`);
    };
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/eoi/getEoiApplicants?projectId=${projectId}&from=${from}&to=${to}&hasSubscription=true&stage=Applied&isApproved=false&isRefund=false`;
