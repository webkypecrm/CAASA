...
const NotEoiApplication = () => {
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/eoi/getEoiApplicants?projectId=${projectId}&from=${from}&to=${to}&hasSubscription=false&stage=Applied&isApproved=false&isRefund=false`;
                                                                            ...
                                                                            {filteredUsers.map((user) => (
                                                                                <tr key={user.id}>
                                                                                    ...
                                                                                    <td >
                                                                                        ...
                                                                                        <br />
                                                                                        Aadhaar Image: <Link to={user.applicantAadhaarImage} title="Aadhaar Image" target="_blank">
                                                                                            <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                        </Link>
                                                                                        <br />
                                                                                        PAN: {user.applicantPAN}
                                                                                        <br />
                                                                                        PAN Image: <Link to={user.applicantPanImage} title="Pan Image" target="_blank">
                                                                                            <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                        </Link>
                                                                                    </td>
                                                                                    ...
                                                                                    <td >
                                                                                        ...
                                                                                        <br />
                                                                                        Unit No: {user.preferredUnitNo?.unitNo}
                                                                                        <br />
...
export default NotEoiApplication
