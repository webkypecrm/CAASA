...
const EditCustomer = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            const Token = localStorage.getItem('Token');
            try {
                const url = `${apiUrl}/eoi/getApplicantById?applicantId=${empid}`;
                let result = await fetch(url, {
                    headers: {
                        Authorization: `Bearer ${Token}`,
                        'Content-Type': 'application/json',
                ...
                setFormData((prevFormData) => ({
                    ...
                    coApplicantFirstName: trimmedData.coApplicantFirstName,
                    coApplicantMiddleName: trimmedData.coApplicantMiddleName,
                    coApplicantLastName: trimmedData.coApplicantLastName,
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/eoi/updateEoiApplicant?applicantId=${empid}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
                                                            ...
                                                            <div className="row row-sm">
                                                                ...
                                                                <div className="col-lg-4 form-group">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value={formData.coApplicantMiddleName}
                                                                        onChange={handleChange}
                                                                        placeholder="Enter"
                                                                        required=""
                                                                        type="text"
