...
const LdubNotAllocated = () => {
    ...
    const loadcontent2 = (id, fullName, middleName, lastName) => {
        // navigation(`/inventory-check/${id}/${fullName}`);
        fetch(`${apiUrl}/applicant/changeApplicantStage?applicantId=${id}&status=notAllocateToApproved`, {
            method: "get",
            headers: {
            ...
            .then((res) => {
                if (res.ok) {
                    fetchDataFromApi();
                    toast.success("Applicant Send to approved section successfully");
                } else {
                    // toast.error("Error while sending to approved")
    ...
    const fetchDataFromApi = async ({
        ...
        setLoading(true);
        const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId}&isUpdated=1&resultStatus=0&search=${search}`;
    ...
    const handleSubmit7 = (event) => {
        ...
        const url = `${apiUrl}/applicant/exportApplicantsToExcelLD?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId}&isUpdated=1&resultStatus=0&search=${search}`;
                                ...
                                <div>
                                    ...
                                    >
                                        <span style={{ fontSize: "16px", marginRight: '10px' }}>
                                            ...
                                            LD Unit Not Blocked List ({luckyDraw.luckyDrawName})
                                        </span>{" "}
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <button
                                                                                                    ...
                                                                                                    onClick={() => loadcontent2(user.id, user.fullName)}
                                                                                                    style={{ marginTop: '5px', backgroundColor: '#17a2b8', borderColor: '#17a2b8' }}
                                                                                                >
                                                                                                    Send back to approved
                                                                                                </button>
                                                                                            ...
                                                                                            <td>
                                                                                                Project: {user.projectName || 'N/A'}
                                                                                                <br />
                                                                                                Type: {user.schemeType || 'N/A'}
                                                                                                <br />
                                                                                                <div>
                                                                                                ...
                                                                                                Lucky Draw: {user?.luckyDraw?.luckyDrawNameAdmin || user?.luckyDrawId}
                                                                                                <br />
                                                                                                Payment Plan: {user.paymentPlan || 'N/A'}
                                                                                                <br />
                                                                                                {/* Advisor: {user.advisorId || 'N/A'} */}
                                                                                                Advisor: {user.advisorName || 'N/A'}
                                                                                                <br />
                                                                                                Advisor Mobile No: {user.advisorMobileNo || 'N/A'}
                                                                                                <br />
                                                                                                Co Advisor: {user.coAdvisorName || 'N/A'}
                                                                                                <br />
                                                                                                Co Advisor Mobile No: {user.coAdvisorMobileNo || 'N/A'}
                                                                                            </td>
                                                                                            <td>

                                                                                                Unit Type:{user.schemeType || 'N/A'}
                                                                                                <br />
...
export default LdubNotAllocated
