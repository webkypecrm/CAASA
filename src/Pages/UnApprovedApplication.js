...
`;
    ...
    const fetchDataFromApi = async () => {
        ...
        const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&stage=${stage}&page=${pageNumber}&limit=${itemsPerPage}&search=${search}&luckyDrawId=${luckyDrawId}&isUpdated=0&resultStatus=0&isVerified=false`;
    ...
    const handleApproved = async (id) => {
        try {
            const url = `${apiUrl}/applicant/backToNew?applicantId=${id}&status=backToNew`;
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">
                                        Dis-Approved Applications List ({leadCount})
                                    </h2>
                                </div>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td >
                                                                                        ...
                                                                                        <button
                                                                                            ...
                                                                                            className="btn ripple btn-xs w-80 mb-1"
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <br />
                                                                                        <strong style={{ color: '#007bff' }}>Remark:</strong> {user.remarks[0]?.unVerifyRemark || 'N/A'}
...
export default UnApprovedApplication
