...
const ProjectInventorys = () => {
    const navigate = useNavigate()
    const { empid, empid2, empid3, empid4, empid7 } = useParams();
    ...
    const fetchDataFromApi = async () => {
        try {
            ...
            const url = `${apiUrl}/inventory/getInventory?id=&mobileNumber=&emailId=&schemeId=${schemeId}&type=${schemeType}&unitNo=${unitNo}&plc=${plc}&size=${size}&allocatedTo=${allocatedTo}&availability=${availability}&projectId=${empid7}&registry=${registry}&isEoi=false&luckyDrawStatus=${luckyDrawStatus}&isApproved=${selectedOption}`;
    ...
    useEffect(() => {
        fetchDataFromApi()
    }, [filterByObj, selectedOption, empid7]);
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">
                                        Inventory Check({projectName})({inventoryCount})
                                    </h2>
...
export default ProjectInventorys
