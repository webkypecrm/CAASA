...
const UploadResult = () => {
    ...
    const fetchDataFromApi = async ({
        ...
        setLoading(true);
        const url = `${apiUrl}/applicant/applicants?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId || ''}&isUpdated=1&resultStatus=1&search=${search}&stage=Applied&isCaseChange=false&orderByAwarded=true`;
    ...
    const handleSubmit7 = (event) => {
        ...
        const url = `${apiUrl}/applicant/exportApplicantsToExcelLD?projectId=${projectId}&schemeId=${schemeId}&schemeType=${schemeType}&from=${from}&to=${to}&luckyDrawId=${luckyDrawId || ''}&isUpdated=1&resultStatus=1&search=${search}&stage=Applied&isCaseChange=false`;
    ...
    const handleApproved = async () => {
        try {
            const url = `${apiUrl}/applicant/changeToCaseChange?applicantId=${holdActionIds}`;
                                ...
                                <div>
                                    ...
                                    >
                                        <span style={{ fontSize: "16px", marginRight: '10px' }}>
                                            ...
                                            LD Unit Blocked List ({luckyDraw.luckyDrawName})
                                        </span>{" "}
                                ...
                                <div className="d-flex">
                                    <div className="justify-content-center">
                                        ...
                                        <div
                                            ...
                                            style={{ display: isModalOpen5 ? 'block' : 'none', backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 9999, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, overflow: 'auto' }}
                                            tabIndex="-1"
                                            role="dialog"
                                        >
                                            <div className="modal-dialog modal-dialog-centered modal-xl" role="document" style={{ maxWidth: '500px', margin: 'auto' }}>
                                                <div className="modal-content" style={{ borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)' }}>
                                                    <div className="modal-header" style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6', borderRadius: '10px 10px 0 0' }}>
                                                        <h5 className="modal-title"> Applicant Upload</h5>
                                                        <button
                                                            type="button"
                                                            className="close"
                                                            data-dismiss="modal"
                                                                                    ...
                                                                                    {users.map((user) => (
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <br />
                                                                                                Registration Amount: <span style={{ color: 'green' }}>{user.registrationAmount || 'N/A'}</span>{" "}



                                                                                                {user.registrationAmount && (
                                                                                                    <>
                                                                                                        <Link to={`/views-welcome-letters/${user.id}`} title="Payment" target="blanck">
                                                                                                ...
                                                                                                <br />
                                                                                                Check Payment:{" "} <Link to={`/single-payment-entry/${user.id}`} title="Payment" target="blanck">
                                                                                                    <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                </Link>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                {user.isWelcomeLetter === true && (
                                                                                                    <Link
                                                                                                        to={`/views-welcome-letters/${user.id}`}
                                                                                                        type="button"
                                                                                                        className="btn ripple btn-info btn-xs w-100 mb-1"
                                                                                                        style={{ marginTop: '5px', backgroundColor: '#17a2b8', borderColor: '#17a2b8' }}
                                                                                                    >
                                                                                                        View Welcome Letter
                                                                                                    </Link>
                                                                                                ...
                                                                                                {!user.isResultShow === false && (
                                                                                                    user.isFirstPaymetDone === true && (
                                                                                                        user.isWelcomeLetter === true && (
                                                                                                            <button
                                                                                                                onClick={() =>
                                                                                                                    loadcontent2(
                                                                                                                        user.id,
                                                                                                                        user.applicantFirstName,
                                                                                                                        user.applicantMiddleName,
                                                                                                                        user.applicantLastName,
                                                                                                                        user
                                                                                                                    )
                                                                                                                }
                                                                                                                type="button"
                                                                                                ...
                                                                                                {user.isWelcomeLetter === true && (
                                                                                                    user.isFirstPaymetDone === false && (
                                                                                                        <Link
                                                                                                            to={`/single-payments-entry/${user.id}`}
                                                                                                            type="button"
                                                                                                            className="btn ripple btn-info btn-xs w-100 mb-1"
                                                                                                            style={{ marginTop: '5px', backgroundColor: '#ff4d4d', borderColor: '#ff4d4d' }}
                                                                                                        >
                                                                                                ...
                                                                                                {user.isWelcomeLetter === false && (
                                                                                                    <>
                                                                                                        <Link
                                                                                                            to={`/sends-welComes-latters/${user.id}`}
                                                                                                            type="button"
                                                                                                            className="btn ripple btn-info btn-xs w-100 mb-1"
                                                                                                            style={{ marginTop: '5px', backgroundColor: '#ff4d4d', borderColor: '#ff4d4d' }}
                                                                                                        >
                                                                                                ...
                                                                                                {user.isWelcomeLetter === false && (
                                                                                                    <>
                                                                                                        This Welcome Letter will go
                                                                                                        <br />
                                                                                                        with Lucky Draw awarded
                                                                                                        <br />
                                                                                                        Unit no to Customer.
                                                                                                    </>
                    ...
                    <div className="modal-dialog modal-dialog-centered" role="document" style={{ maxWidth: '400px', margin: 'auto' }}>
                        <div className="modal-content" style={{ borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)' }}>
                            <div className="modal-header" style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6', borderRadius: '10px 10px 0 0' }}>
                                ...
                                <button type="button" className="close" aria-label="Close" onClick={handleCloseModals4}>
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div className="modal-body text-center" style={{ padding: '20px' }}>
                                {[
                                    [{ label: 'Lucky Draw', status: 'fail' }, { label: 'Scheme', status: 'fail' }],
                                    [{ label: 'Project', status: 'pass' }, { label: 'Unit Type', status: 'pass' }, { label: 'Unit No', status: 'pass' }, { label: 'Size', status: 'pass' }],
                                    [{ label: 'BSP', status: 'pass' }, { label: 'EDC/IDC', status: 'pass' }, { label: 'PLC', status: 'pass' }],
                                ].map((group, groupIndex) => (
                                    <div key={groupIndex} className="d-flex justify-content-center flex-wrap">
                                        {group.map(({ label, status }, index) => (
                                            <div
                                                key={index}
                                                ...
                                                style={{
                                                    ...
                                                    padding: '6px 10px',
                                                    borderRadius: '6px',
                                                    background: status === 'fail' ? '#ffe5e5' : '#e5f7e5',
                                                    color: status === 'fail' ? '#d9534f' : '#28a745',
                                                    width: '120px',
                                                    display: 'flex',
                                                    justifyContent: 'space-between',
                                                    alignItems: 'center',
                                            ...
                                            >
                                                {label}
                                                <i className={`fas fa-${status === 'fail' ? 'times' : 'check'}-circle`} style={{ fontSize: '16px' }}></i>
                                            </div>
                                        ))}
                                    </div>
                                ))}
                                <p className="mt-3" style={{ fontSize: '13px', fontWeight: '500', color: '#333' }}>
                                    This application will be moved to case change to Re-Award unit and follow process.
                                </p>
                                <div className="modal-footer d-flex justify-content-center">
                                    <button type="button" className="btn btn-primary" onClick={handleApproved}>
                                        Yes Continue
                                    </button>
                                </div>
                            </div>
