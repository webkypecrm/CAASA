...
const AllPaymentRemainder = () => {
    ...
    const fetchDataFromApi = async () => {
        setLoading(true);
        try {
            const { reminderType } = filterByObj;
            const url = `${apiUrl}/applicant/reminderLetterList?&reminderType=${reminderType}`;
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm-4">
                                                    <select className="form-control select2"
                                                        name="reminderType"
                                                        value={filterByObj.reminderType}
                                                        onChange={handleInputChange2}
                                                    >
                                                        <option value=''>Select Payment Remainder</option>
                                                                        ...
                                                                        <tbody>
                                                                            {filteredUsers.map((user) => (
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        TID: {user && user.applicant && `${user.applicant.ticketId}`}
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <br />
                                                                                        Area: <font color="red">{user && user.applicant && `${user.applicant.size}`}</font>
                                                                                        <br />
                                                                                        Gift: <font color="red">{user.gift}{" "}
                                                                                            {user && user.applicant && `${user.applicant.otherGift}`}
                                                                                        </font>

                                                                                    </td>
                                                                                    <td>
                                                                                        Payment Remainder View: {" "}
                                                                                        {user.reminderType === 'Payment Intimation' && (
                                                                                            <>
                                                                                                <Link to={`/remainder-payment-information/${user && user.inventoryFollowUp && `${user.inventoryFollowUp.id}`}`} target="__blanck" title="Welcome Letter">
                                                                                                    <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                </Link>
                                                                                            </>
                                                                                        )}
                                                                                        {user.reminderType === 'Plan Change' && (
                                                                                            <>
                                                                                                <Link to={`/remainder-plan-change/${user && user.inventoryFollowUp && `${user.inventoryFollowUp.id}`}`} target="__blanck" title="Welcome Letter">
                                                                                                    <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                </Link>
                                                                                            </>
                                                                                        )}
                                                                                        {user.reminderType === 'Final Payment Intimation' && (
                                                                                            <>
                                                                                                <Link to={`/remainder-final-payment-intimation/${user && user.inventoryFollowUp && `${user.inventoryFollowUp.id}`}`} target="__blanck" title="Welcome Letter">
                                                                                                    <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                </Link>
                                                                                            </>
                                                                                        )}
                                                                                        {user.reminderType === 'Final Cancel' && (
                                                                                            <>
                                                                                                <Link to={`/remainder-final-cancel/${user && user.inventoryFollowUp && `${user.inventoryFollowUp.id}`}`} target="__blanck" title="Welcome Letter">
                                                                                                    <i className="fe fe-eye me-3" style={{ cursor: 'pointer' }} />
                                                                                                </Link>
                                                                                            </>
                                                                                        )}
...
export default AllPaymentRemainder
