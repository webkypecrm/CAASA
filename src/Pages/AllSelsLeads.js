...
const AllSelsLeads = () => {
    ...
    async function deleteLead() {
        const url = `${apiUrl}/lead/deleteLead?leadId=${holdActionId}`;
    ...
    const leadsAssign = async (e) => {
        ...
        try {
            ...
            // Append the file to formDataToSend
            formDataToSend.append('excelFile', formData3.empId);
    ...
    const handleChanges = (dates) => {
        ...
        setFilterByObj(prevState => ({
            ...prevState,
            assignedFrom: `${formattedStartDate}`,
            assignedTo: `${formattedEndDate}`
        }));
    };
    ...
    const handleSubmits = async (e) => {
        ...
        try {
            ...
            const url = `${apiUrl}/lead/leadExcel?to=${to}&from=${from}&search=${search}&clientName=${clientName}&clientNumber=${clientNumber}&status=${status}&employeeId=${employeeId}&project=${project}&source=${source}&size=${size}&page=${pageNumber}&limit=${itemsPerPage}&leadIds=${selectedItems}&leadIds=${selectedItems}&search=${search}&utmSource=${utmSource}&vendor=${vendor}&assignedFrom=${assignedFrom}&assignedTo=${assignedTo}&isSuffleLead=${isSuffleLead}`;
    ...
    useEffect(() => {
        fetchDataFromApi();
    }, [currentPage, filterByObj, itemsPerPage, filterByObj.status]);
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">All {statuss}({leadCount})</h2>
                                </div>
                                    ...
                                    <div className="card custom-card">
                                        <div className="card-body py-3">
                                            <div className="row">
                                                ...
                                                <div className="col-sm-3 form-group" >
                                                    <label className="form-label">Suffle/Live Lead</label>
                                                    <select
                                                        className="form-control"
                                                        name="isSuffleLead"
                                                        value={filterByObj.isSuffleLead}
                                                        onChange={handleInputChange}
                                                    >
                                                        <option value="">Select</option>
                                                        <option value="true">Suffle Lead</option>
                                                        <option value="false">Live Lead</option>

                                                    </select>
                                                </div>

                                                <div className="col-sm-3">
                                                    <label className="form-label">Select Assigned Date Form/To</label>
                                                    <div className="input-group">
                                                        <div className="input-group-text border-end-0">
                                                            <i className="fe fe-calendar lh--9 op-6" />
                                                        </div>
                                                ...
                                                <div className="col-sm-0 d-flex justify-content-end" style={{ marginTop: '-15px' }}>
                                                            ...
                                                            {currentPageData.map((user) => (
                                                                ...
                                                                <tr key={user.id}>
                                                                    ...
                                                                    <td style={{ whiteSpace: 'nowrap' }}>
                                                                        ...
                                                                        <a onClick={() => handleOpenModals4(user.id)}>
                                                                            <i className="fa fa-trash me-3" style={{ cursor: 'pointer' }} />
                                                                        </a>
