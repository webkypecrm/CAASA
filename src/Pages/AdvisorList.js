...
const AdvisorList = () => {
    ...
    const fetchDataFromApi = async () => {
        setLoading(true);
        const { department, designation, isAdvisor } = filterByObj;
        const url = `${apiUrl}/employee/employees?id=&mobileNumber=&emailId=&department=${department}&designation=${designation}&isAdvisor=${isAdvisor}`;

        const formDataToSend = new FormData();
        formDataToSend.append('status', formData2.status ? true : true);
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Advisor List</h2>
                                </div>
                            </div>
                            {/* End Page Header */}
                            <div className="row">
