...
const SendwelcomeData = () => {
    ...
    useEffect(() => {
        ...
        // Extract plcString directly
        const plcString = formData.plcdd; // This is directly "7"

        // Check if areaValue is a valid number and plcString is defined
        if (!isNaN(areaValue) && plcString) {
            const percentage = parseFloat(plcString); // Directly convert to number

            // Calculate the percentage of areaValue
            const percentageValue = (areaValue * percentage) / 100;

            // Format the percentage value to remove decimals
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/upload-updated-result`);
    ...
    useEffect(() => {
        ...
        if (!isNaN(areaValue) && !isNaN(priceValue)) {
            ...
            const roundedValue = Math.floor(percentageValue);

            // Set the total as a whole number (without decimals)
            setTotal1(roundedValue);
        } else {
            setTotal1(null);
        }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style={{ padding: "1px 30px", border: "1px solid #ccc" }}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <option value={formData.plan.defaultPlc}>
                                                                            {formData.plan.defaultPlc}
                                                                        </option>
                                                                        <option value={formData.plan.cornerPlc}>
                                                                            {formData.plan.cornerPlc}
                                                                        </option>
                                                                        <option value={formData.plan.mainRoadPlc}>
                                                                            {formData.plan.mainRoadPlc}
                                                                        </option>
                                                                        <option value={formData.plan.facultyParkPlc}>
                                                                            {formData.plan.facultyParkPlc} */}
                                                                        {/* </option> */}
                                                                    </input>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <p style={{ marginTop: 0, marginBottom: 10 }}>
                                                                                                                ...
                                                                                                                <span style={{ color: 'blue' }}>{formData.advisorNameWL}</span>{" "}
                                                                                                                and will be reachable on{" "} {formData.advisorPhoneNumberWL}{" "}
                                                                                                                for any queries.{" "}
                                                                                                            </p>
                                                                                                        </td>
                                                                                                    </tr>
...
export default SendwelcomeData
