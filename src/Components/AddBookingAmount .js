...
const AddBookingAmount = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/payment/updateLdPayment?paymentId=${idsss}`, {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${Token}`,
                },
    ...
    const fetchDataFromApiTwo = () => {
        fetch(`${apiUrl}/payment/getPayment?applicantId=${empid}&isDeleted=false&checkInHand=true`, {
            headers: {
                'Authorization': `Bearer ${Token}`
            }
        })
                                        ...
                                        <div className="card custom-card">
                                            <div className="card-body" style={{ width: '1320px' }} >
                                                <div>
                                                    ...
                                                    <span onClick={handleOpenModal60} style={{ color: 'blue', display: 'inline-block', marginLeft: '90px', fontFamily: 'Roboto, sans-serif', cursor: 'pointer' }}>
                                        ...
                                        <div className="card custom-card" >
                                            <div className="card-body" style={{ width: '600px' }}>
                                                <div>
                                                    ...
                                                    <span className="text-muted">Type:{' '}{employee4.schemeType}--
                                                        (
                                                        {
                                                            (() => {
                                                    ...
                                                    <div style={{ display: "flex", flexWrap: "wrap", rowGap: "10px", columnGap: "20px" }}>
                                                        ...
                                                        {employee4.resultStatus !== undefined && (
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    style={{
                                                                        color: employee4.resultStatus === 1 ? "green" : "red",
                                                                        fontSize: "16px",
                                                                        marginLeft: "10px",
                                                                    }}
                                                                >
                                                                    <i className={`fas ${employee4.resultStatus === 1 ? "fa-check-circle" : "fa-times-circle"}`}></i>
                                                                </span>
                                                            </div>
                                                        )}
                                                        ...
                                                        {employee4.isFirstPaymet !== undefined && (
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    style={{
                                                                        color: employee4.isFirstPaymet ? "green" : "red",
                                                                        fontSize: "16px",
                                                                        marginLeft: "10px",
                                                                    }}
                                                                >
                                                                    <i className={`fas ${employee4.isFirstPaymet ? "fa-check-circle" : "fa-times-circle"}`}></i>
                                                                </span>
                                                            </div>
                                                        )}
                                                        ...
                                                        {employee4.isWelcomeLetter !== undefined && (
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    style={{
                                                                        color: employee4.isWelcomeLetter ? "green" : "red",
                                                                        fontSize: "16px",
                                                                        marginLeft: "10px",
                                                                    }}
                                                                >
                                                                    <i
                                                                        className={`fas ${employee4.isWelcomeLetter ? "fa-check-circle" : "fa-times-circle"
                                                                            }`}
                                                                    ></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        {employee4.isAllotmentLetter !== undefined && (
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    style={{
                                                                        color: employee4.isAllotmentLetter ? "green" : "red",
                                                                        fontSize: "16px",
                                                                        marginLeft: "10px",
                                                                    }}
                                                                >
                                                                    <i
                                                                        className={`fas ${employee4.isAllotmentLetter ? "fa-check-circle" : "fa-times-circle"
                                                                            }`}
                                                                    ></i>
                                                                </span>
                                                            </div>
...
`}
                            ...
                            <div style={{ width: '100%', backgroundColor: 'var(--primary-bg-color)', padding: '5px 20px', marginTop: '20px' }}>
                                <h5 style={{ textAlign: 'left', color: '#ffffff', fontSize: '-10rem', margin: '0' }}>Delete Payment History</h5>
                            </div>
...
`}
                            ...
                            <div style={{ width: '100%', backgroundColor: 'var(--primary-bg-color)', padding: '5px 20px', marginTop: '20px' }}>
                                <h5 style={{ textAlign: 'left', color: '#ffffff', fontSize: '-10rem', margin: '0' }}>Cheques in Hand</h5>
                            </div>
                                                                                    ...
                                                                                    {user.dueAmount && (
                                                                                        <>
                                                                                            ...
                                                                                            {/* {user.showButton === true && (
                                                                                                <Link
                                                                                                    to={`/demand-letter/${user.id}/${empid}`}
                        ...
                        >
                            ...
                            >
                                <h5 className="modal-title" style={{ margin: 0 }}>
                                    UID: {employee4.userId} ({employee4.applicantFirstName} {employee4.applicantLastName})
                                </h5>
                                <button
                                    type="button"
                                    className="btn-close"
...
export default AddBookingAmount
