...
const Content3 = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            try {
                const url = `${apiUrl}/buyer/buyer/${empid}`;
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/buyer/updateBuyer/${empid}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${Token}`,
                },
                    ...
                    <div className="main-container container-fluid">
                        <div className="inner-body">
                            ...
                            <div className="page-header">
                                <div>
                                    <h2 className="main-content-title tx-24 mg-b-5">Buyers Update</h2>
